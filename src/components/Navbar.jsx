...
export function Navbar() {
    ...
    return (
        <nav className="navbar navbar-expand-lg bg-dark sticky-top">
            <NavLink
                className="text-light fw-bold fs-2 text-decoration-none me-lg-4 ms-lg-4 ms-3 me-0 mb-lg-0 mb-4 mt-lg-0 mt-4"
                to="/"
                end
            >PolyPoll</NavLink>
            <button className="navbar-toggler bg-light me-4 focus-ring focus-ring-dark" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                <span className="navbar-toggler-icon"></span>
            </button>
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <div className="container-fluid d-flex flex-lg-row align-items-lg-center justify-content-lg-between justify-content-md-between py-lg-2 py-0 flex-column">
                    ...
                    <div className="d-flex justify-content-lg-end justify-content-center mt-lg-0 mt-4 mb-lg-0 mb-3 me-lg-2 me-0 ms-lg-5 ms-0">
