...
import { PollDetailsById } from "../components/PollDetailsById";
...
export function Home() {
    ...
    return (
        <div id="home" className="container-fluid d-flex flex-column align-items-center gap-5 vh-150 bg-info-subtle">
