...
export function PollConfigModal({ show, onClose, children }) {
  ...
  return (
    <div style={styles.overlay}>
      <div className="w-auto h-auto bg-light rounded-5 d-flex flex-column align-items-center justify-content-center">
        ...
        {children}
        <div className="w-100 my-3" style={{height: "1px", backgroundColor: "rgba(0, 0, 0, 0.1)"}}></div>
        <button className="btn rounded-5 fw-bold custom-hover mb-4 mt-1 px-4" style={{ backgroundColor: "#9e42f5", color: "white" }} onClick={onClose}>Close</button>
      </div>
    </div>
  );
}
